...
ggplot(data=wine,aes(,x=sulphates,y=volatile.acidity))+
  geom_point(alpha=.5,aes(color=quality))+
  scale_color_brewer(palette='RdYlGn', 
                     guide = guide_legend(title = 'Quality', reverse = T, 
                                          override.aes = list(alpha = 1, 
                                                              size = 2)))
...
which tend to have no citric acid and high amounts of volatile acid.
